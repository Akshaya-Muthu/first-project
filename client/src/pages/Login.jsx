...
const Login = () => {
  ...
  return (
    ...
    sm:px-0 bg-gradient-to-br from-white to-purple-400'>
        ...
        <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
          ...
          <form onSubmit={onSubitHandler}>
            {state === 'Sign Up' && (
              ...
              className='bg-transparent outline-none' type="text" placeholder='Your Name' required/>
            </div>
          )}
            ...
            <button className='w-full py-2.5 rounded-full bg-gradient-to-r
             from-indigo-500 to bg-indigo-900 text-white font-medium'>{state}</button>
